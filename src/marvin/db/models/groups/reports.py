...
class ReportEntryModel(SqlAlchemyBase, BaseMixins):
    ...
    message: Mapped[str | None] = mapped_column(
        String, nullable=True, doc="A descriptive message for this report entry."
    )  # Corrected Mapped[str] to Mapped[str | None]
    exception: Mapped[str | None] = mapped_column(
        String, nullable=True, doc="Details of any exception that occurred, if applicable."
    )  # Corrected Mapped[str] to Mapped[str | None]
    timestamp: Mapped[datetime] = mapped_column(
        NaiveDateTime, nullable=False, default=get_utc_now, doc="Timestamp of when this entry was created (UTC)."
    )
...
class ReportModel(SqlAlchemyBase, BaseMixins):
    ...
    timestamp: Mapped[datetime] = mapped_column(
        ...
        nullable=False,
        default=get_utc_now,
        doc="Timestamp of when this report was created or last updated (UTC).",
    )
    ...
    entries: Mapped[list["ReportEntryModel"]] = orm.relationship(
        ...
        doc="List of entries within this report.",
    )
