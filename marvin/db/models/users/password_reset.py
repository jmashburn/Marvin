...
class PasswordResetModel(SqlAlchemyBase, BaseMixins):
    ...
    user_id: Mapped[GUID] = mapped_column(GUID, ForeignKey("users.id"), nullable=False, index=True, doc="The ID of the user who requested the password reset.")
    ...
    token: Mapped[str] = mapped_column(String(64), unique=True, nullable=False, index=True, doc="The securely generated password reset token string. Indexed for quick lookups.")
