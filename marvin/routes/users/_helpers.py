...
from marvin.schemas.user.user import PrivateUser, UserCreate

permission_attrs = ["can_invite", "can_manage", "can_organize", "admin"]


def _assert_non_admin_user_change_allowed(user_id: UUID4, current_user: PrivateUser, new_data: UserCreate):
...
def assert_user_change_allowed(user_id: UUID4, current_user: PrivateUser, new_data: UserCreate):
