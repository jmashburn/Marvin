...
# from marvin.routes._base.mixins import HttpRepo # HttpRepo mixin was imported but not used
# from marvin.schemas.mapper import cast # `cast` import was not used
...
router = APIRouter(prefix="/event", tags=["Events - Notifier Options"], route_class=MarvinCrudRoute)
