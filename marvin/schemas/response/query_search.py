...
from marvin.db.models import SearchType, _MarvinModel
...
class SearchFilter:
    ...
    def filter_query_by_search(self, query: Select, schema: type[_MarvinModel], model: type[SqlAlchemyBase]) -> Select:
