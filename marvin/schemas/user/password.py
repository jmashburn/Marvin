...
class PrivatePasswordResetToken(SavePasswordResetToken):
    ...
    def loader_options(cls) -> list[LoaderOption]:
        ...
        return [
            ...
            selectinload(PasswordResetSQLModel.user)
            .joinedload(UsersSQLModel.group), # Then, from that user, joinedload their group
            selectinload(PasswordResetSQLModel.user)
            .joinedload(UsersSQLModel.tokens), # Also, from that user, joinedload their API tokens
        ]
